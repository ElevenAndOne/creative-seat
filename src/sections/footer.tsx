...
export default function SiteFooter() {
  return (
    <footer className="bg-black py-14 text-white">
      <Container className="flex flex-row items-center justify-between gap-10 landscape:flex-col landscape:items-center">
        ...
        <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-white/70 landscape:hidden">A product of</span>
