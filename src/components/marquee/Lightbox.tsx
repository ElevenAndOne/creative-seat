        ...
        {project && (
          <Dialog.Portal>
            <Dialog.Popup
              ...
              className="fixed inset-0 z-50 overflow-hidden bg-plum/95 outline-none"
            >
              <Dialog.Close
                ref={closeRef}
                aria-label="Close"
                className="absolute right-6 top-6 z-20 flex h-11 w-11 items-center justify-center rounded-round bg-white/10 text-2xl text-white transition hover:bg-white/20 focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-plum"
              >
              ...
              >
                <div className="flex items-end justify-between gap-xlg landscape:flex-col landscape:items-start landscape:gap-md">
                  <div className="shrink-0">
                    <Dialog.Title className="text-h2 leading-none">{project.title}</Dialog.Title>
                    <p className="mt-sm text-sm uppercase tracking-[0.18em] text-white/60">{project.category}</p>
                  </div>
                  <Dialog.Description className="max-w-[34rem] text-base leading-relaxed text-white/85">{project.description}</Dialog.Description>
